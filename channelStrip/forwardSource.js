function anything()
{
	...
	// switch(argList[0]){
	// 	case "adc": 
	// 		{this.send("audio-from",["symbol", "adc"]); this.send("adc-channel",parseInt(argList[1]))};
	// 		break;
	// 	case "receive": 
	// 		{this.send("audio-from",["symbol", "receive"]); this.send("receive-name",["set", argList[1]])};
	// 		break;
	// 	case "matrix": 
	// 		{this.send("audio-from",["symbol", "matrix"]); this.send("matrix-channel",parseInt(argList[1]))};
	// 		break;
	// 	case "inlet": 
	// 		{this.send("audio-from",["symbol", "inlet"])};
	// 		break;
	// }
